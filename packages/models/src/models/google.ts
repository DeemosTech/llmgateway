...
export const googleModels = [
	{
		...
		description: "Google's Veo 3.1 preview model for text-to-video generation.",
		family: "google",
		output: ["video"],
		...
		providers: [
			{
				...
				videoPricePerSecond: 0.2,
				videoPricePerSecondWithAudio: 0.4,
			},
			{
				test: "skip",
	...
	},
	{
		...
		description:
			"Lower-latency Veo 3.1 preview model for text-to-video generation.",
		family: "google",
		output: ["video"],
		releasedAt: new Date("2026-02-25"),
		providers: [
			{
				...
				videoPricePerSecondWithAudio: 0.15,
			},
			{
				test: "skip",
				providerId: "google-vertex",
		...
		providers: [
			{
				...
				inputPrice: 0.0 / 1e6,
				outputPrice: 0.0 / 1e6,
				requestPrice: 0.028000000000000004,
				contextSize: 65536,
				maxOutput: 32768,
				streaming: true,
				vision: true,
