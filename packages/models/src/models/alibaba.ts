...
export const alibabaModels = [
	...
	},
	{
		...
		description: "Alibaba Cloud's Qwen3 Coder Plus model.",
		family: "alibaba",
		...
		providers: [
			{
				test: "skip",
				providerId: "tuzi",
				modelName: "qwen3-coder-plus-2025-07-22",
				inputPrice: 2.0 / 1e6,
	...
	},
	{
		...
		providers: [
			...
			},
			{
				...
				modelName: "qwen3-14b",
				inputPrice: 0.1 / 1e6,
				outputPrice: 0.7000000000000001 / 1e6,
				requestPrice: 0,
				contextSize: 128000,
				maxOutput: undefined,
				streaming: true,
	...
	},
	{
		...
		providers: [
			...
			},
			{
				...
				modelName: "qwen3-32b",
				inputPrice: 0.2 / 1e6,
				outputPrice: 1.4000000000000001 / 1e6,
				requestPrice: 0,
				contextSize: 128000,
				maxOutput: undefined,
				streaming: true,
	...
	},
	{
		...
		providers: [
			...
			},
			{
				...
				inputPrice: 0.15000000000000002 / 1e6,
				outputPrice: 1.05 / 1e6,
				requestPrice: 0,
				contextSize: 128000,
				maxOutput: undefined,
				streaming: true,
	...
	},
	{
		id: "qwen3-8b",
		name: "Qwen3 8B",
		description: "Alibaba Cloud's Qwen3 8B model.",
		family: "alibaba",
		...
		providers: [
			{
				...
				modelName: "qwen3-8b",
				inputPrice: 0.05 / 1e6,
				outputPrice: 0.35000000000000003 / 1e6,
				requestPrice: 0,
				contextSize: 128000,
				maxOutput: undefined,
				streaming: true,
	...
	},
	{
		...
		description: "Alibaba Cloud's Qwen3 235B A22B model.",
		family: "alibaba",
		releasedAt: new Date("2025-01-01"),
		providers: [
			{
				...
				inputPrice: 0.4 / 1e6,
				outputPrice: 2.8000000000000003 / 1e6,
				requestPrice: 0,
				contextSize: 128000,
				maxOutput: undefined,
				streaming: true,
	...
	},
	{
		id: "qwen-72b",
		name: "Qwen 72B",
		description: "Alibaba Cloud's Qwen 72B large language model.",
		family: "alibaba",
		releasedAt: new Date("2025-01-01"),
		providers: [
			{
	...
	},
	{
		id: "qwen-image-2.0",
		name: "Qwen Image 2.0",
		description: "Alibaba Cloud's Qwen image generation model.",
		family: "alibaba",
		output: ["text", "image"],
		releasedAt: new Date("2025-01-01"),
		providers: [
			{
				...
				inputPrice: 0.0 / 1e6,
				outputPrice: 0.0 / 1e6,
				requestPrice: 0.010000000000000002,
				contextSize: 2000,
				maxOutput: 4096,
				streaming: false,
				vision: false,
	...
	},
	{
		id: "qwen3-4b",
		name: "Qwen3 4B",
		description: "Alibaba Cloud's Qwen3 4B model.",
		family: "alibaba",
		releasedAt: new Date("2025-01-01"),
		providers: [
			{
				...
				modelName: "qwen3-4b",
				inputPrice: 0.03 / 1e6,
				outputPrice: 0.21000000000000002 / 1e6,
				requestPrice: 0,
				contextSize: 128000,
				maxOutput: undefined,
				streaming: true,
