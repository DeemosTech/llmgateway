...
export const openaiModels = [
	...
	},
	{
		id: "gpt-image-1.5",
		name: "GPT Image 1.5",
		description: "OpenAI's GPT Image generation model 1.5.",
		family: "openai",
		output: ["text", "image"],
		releasedAt: new Date("2025-08-01"),
		providers: [
	...
	},
	{
		...
		name: "Sora 2",
		description:
			"OpenAI's video generation model for fast text-to-video output.",
		family: "openai",
		output: ["video"],
		...
		providers: [
			{
				...
				videoPricePerSecondWithAudio: 0.1,
			},
			{
				providerId: "tuzi",
				modelName: "sora-2",
				...
				jsonOutput: false,
				videoGenerations: true,
				videoPricePerSecond: 0.01,
				videoPricePerSecondWithAudio: 0.01,
			},
		],
	},
	{
		...
		name: "Sora 2 Pro",
		description:
			"Premium OpenAI video generation model with higher-quality output tiers.",
		family: "openai",
		output: ["video"],
		releasedAt: new Date("2026-03-01"),
		providers: [
			{
				...
				jsonOutput: false,
				videoGenerations: true,
				videoPricePerSecond: 0.3,
				videoPricePerSecondWithAudio: 0.3,
			},
			{
				providerId: "tuzi",
				modelName: "sora-2-pro",
	...
	},
	{
		...
		providers: [
			...
			},
			{
				...
				providerId: "tuzi",
				modelName: "o3-mini",
				inputPrice: 0.11000000000000001 / 1e6,
				outputPrice: 0.7700000000000001 / 1e6,
				requestPrice: 0,
				contextSize: 200000,
				maxOutput: undefined,
				streaming: true,
	...
	},
	{
		...
		providers: [
			...
			},
			{
				...
				providerId: "tuzi",
				modelName: "gpt-5-mini",
				inputPrice: 0.025 / 1e6,
				outputPrice: 0.17500000000000002 / 1e6,
				requestPrice: 0,
				contextSize: 400000,
				maxOutput: 128000,
				reasoning: true,
	...
	},
	{
		...
		providers: [
			...
			},
			{
				...
				providerId: "tuzi",
				modelName: "gpt-5-nano",
				inputPrice: 0.005000000000000001 / 1e6,
				outputPrice: 0.035 / 1e6,
				requestPrice: 0,
				contextSize: 400000,
				maxOutput: 128000,
				reasoning: true,
	...
	},
	{
		...
		providers: [
			...
			},
			{
				...
				providerId: "tuzi",
				modelName: "gpt-5.2",
				inputPrice: 0.17500000000000002 / 1e6,
				outputPrice: 1.225 / 1e6,
				requestPrice: 0,
				contextSize: 400000,
				maxOutput: 128000,
				streaming: true,
